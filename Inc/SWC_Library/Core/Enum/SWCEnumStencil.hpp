    ...
    namespace Enum
    {
        namespace Stencil
        {
            ...
            namespace Op
            {
                ...
                typedef ::Wiz::Enum<::swc::Enum::Stencil::Op::____, ::wms::U8::type>::Type Type;
                WMS_DECLARE(::swc::Enum::Stencil::Op::Type);
            } /// end of namespace Op
            ...
            namespace Compare
            {
                ...
                typedef ::Wiz::Enum<::swc::Enum::Stencil::Compare::____, ::wms::U8::type>::Type Type;
                WMS_DECLARE(::swc::Enum::Stencil::Compare::Type);
