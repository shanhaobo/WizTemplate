    ...
    namespace Enum
    {
        ...
        namespace Blend
        {
            namespace Usage
            {
                ...
                typedef ::Wiz::Enum<::swc::Enum::Blend::Usage::____, ::wms::U8::type>::Type Type;
                WMS_DECLARE(::swc::Enum::Blend::Usage::Type);
            ...
            namespace Factor
            {
                ...
                typedef ::Wiz::Enum<::swc::Enum::Blend::Factor::____, ::wms::U8::type>::Type Type;
                WMS_DECLARE(::swc::Enum::Blend::Factor::Type);
            ...
            namespace Op
            {
                ...
                typedef ::Wiz::Enum<::swc::Enum::Blend::Op::____, ::wms::U8::type>::Type Type;
                WMS_DECLARE(::swc::Enum::Blend::Op::Type);
            } /// end of namespace Op
            ...
            namespace Test
            {
                ...
                typedef ::Wiz::Enum<::swc::Enum::Blend::Test::____, ::wms::U8::type>::Type Type;
                WMS_DECLARE(::swc::Enum::Blend::Test::Type);
