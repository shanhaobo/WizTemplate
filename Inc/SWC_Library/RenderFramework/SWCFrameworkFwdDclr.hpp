#ifndef __SIMWORLDCORE_FRAMEWORK_FORWARD_DELCARE_HPP__
#define __SIMWORLDCORE_FRAMEWORK_FORWARD_DELCARE_HPP__
...
namespace swc
{
    ...
    namespace Obj
    {
        namespace Framework
        {
            namespace General
            {
                WMS_DECLARE(::wms::Obj::type<::swc::Allocator::Framework::General::type>);
            }
            namespace Render
			{
				namespace Cmd
				{
					WMS_DECLARE(::wms::Obj::type<::swc::Allocator::Framework::Render::Cmd::type>);
				}
                WMS_DECLARE(::wms::Obj::type<::swc::Allocator::Framework::Render::type>);
            }
        } /// end of namespace Framework
...
#endif /// #ifndef __SIMWORLDCORE_FRAMEWORK_FORWARD_DELCARE_HPP__
